...
def attack(char_name: str, char_class: str) -> str:
    """Функция регламентирует нанесения урона."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция регламентирует блокирование урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция регламентирует специальное умение."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция описывает выбранный игроком класс и действия в игре."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция выбора класса игрового персонажа."""
    approve_choice: str = ''
    char_class: str = ''
